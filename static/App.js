...
var IssueRow = function IssueRow(props) {
  return React.createElement(
    "tr",
    null,
    React.createElement("td", null, props.issue._id),
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("th", null, "Fecha de creaci\xF3n"),
        React.createElement("th", null, "Esfuero"),
        React.createElement("th", null, "Fecha de finalizaci\xF3n"),
        React.createElement("th", null, "T\xEDtulo")
      )
    ),
...
var IssueFilter = (function(_React$Component) {
  ...
  function IssueFilter() {
    ...
    return _possibleConstructorReturn(
      this,
      (IssueFilter.__proto__ || Object.getPrototypeOf(IssueFilter)).apply(
        this,
        arguments
      )
    );
  ...
  _createClass(IssueFilter, [
    {
      ...
      value: function render() {
        return React.createElement(
          "div",
          null,
          "Marcador para el filtro de incidentes"
        );
      }
    }
  ]);
            ...
            if (response.ok) {
              response.json().then(function(updateIssue) {
                ...
                if (updateIssue.completionDate) {
                  updateIssue.completionDate = new Date(
                    updateIssue.completionDate
                  );
                }
    ...
    },
    {
      ...
      value: function render() {
        return React.createElement(
          "div",
          null,
          React.createElement("h1", null, "Explorador de problemas"),
          React.createElement(IssueFilter, null),
          React.createElement("hr", null),
          React.createElement(IssueTable, { issues: this.state.issues }),
          React.createElement("hr", null),
          React.createElement(_IssueAdd2.default, {
